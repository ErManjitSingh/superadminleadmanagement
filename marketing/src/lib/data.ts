...
export const megaIndia = [
  {
    ...
    links: [
      ...
      { label: "Himachal Tour Packages", href: "#himachal" },
      { label: "Andaman Tour Packages", href: "#packages" },
      { label: "Spiti Tour Packages", href: "#himachal" },
    ],
  },
  {
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Himachal Family Packages", href: "#himachal" },
    ],
  },
  {
    ...
    links: [
      ...
      { label: "Spiti Bike Trip Packages", href: "#himachal" },
      { label: "Manali Tour Packages", href: "#himachal" },
    ],
  },
];
...
export const megaHoneymoon = [
  ...
  },
  {
    title: "Hill Stations",
    links: [
      { label: "Manali Honeymoon", href: "#himachal" },
      { label: "Shimla Honeymoon", href: "#himachal" },
...
export const megaFamily = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Himachal Family Trip", href: "#himachal" },
...
export const destinationSections: DestinationSection[] = [
  {
    ...
    packages: [
      {
        id: "hp-1",
        title: "McLeodganj Triund Trek | Camping under the Dhauladhar",
        duration: "1 night & 2 days",
        rating: 4.8,
        reviews: 412,
        stays: [
          { days: 1, place: "McLeodganj" },
          { days: 1, place: "Triund" },
        ],
        priceWas: 2499,
        priceNow: 999,
      ...
      {
        id: "hp-2",
        title: "Delhi to McLeodganj Triund | Overnight Trek & Camping",
        duration: "1 night & 2 days",
        rating: 4.7,
        reviews: 286,
        stays: [
          { days: 1, place: "Dharamshala" },
          { days: 1, place: "Triund" },
        ],
        priceWas: 5999,
        priceNow: 3999,
      ...
      {
        id: "hp-3",
        title: "Kheerganga Trek | Hot Springs Camp from Barshaini",
        duration: "1 night & 2 days",
        rating: 4.9,
        reviews: 538,
        stays: [
          { days: 1, place: "Kasol" },
          { days: 1, place: "Kheerganga" },
        ],
        priceWas: 2499,
        priceNow: 999,
        per: "/Adult",
      ...
      {
        id: "hp-4",
        title: "Kareri Lake Trek | Alpine Lake from Dharamshala",
        duration: "1 night & 2 days",
        rating: 4.8,
        reviews: 194,
        stays: [
          { days: 1, place: "Dharamshala" },
          { days: 1, place: "Kareri Lake" },
        ],
        priceWas: 3499,
        priceNow: 2499,
        per: "/Adult",
        image: photo("photo-1483728642387-6c79b6b38a37"),
        badge: "Trending",
      },
      {
        id: "hp-5",
        title: "Manali Getaway | Solang, Hadimba & Mountain Views",
        ...
        priceNow: 12999,
        per: "/Adult",
        image: photo("photo-1597076545399-91a3ff0e71b3"),
      },
      {
        id: "hp-6",
        title: "Shimla & Kufri | Family Hill Station Escape",
        duration: "4 days & 3 nights",
        rating: 4.6,
        reviews: 241,
        stays: [
      ...
      {
        id: "hp-7",
        title: "Kasol & Manikaran | Parvati Valley Weekend",
        duration: "3 days & 2 nights",
        rating: 4.7,
        reviews: 318,
        stays: [
          { days: 2, place: "Kasol" },
          { days: 1, place: "Manikaran" },
        ],
        priceWas: 9999,
        priceNow: 6999,
        per: "/Adult",
      ...
      {
        id: "hp-8",
        title: "Spiti Valley Road Trip | Kaza, Key Monastery & Chandratal",
