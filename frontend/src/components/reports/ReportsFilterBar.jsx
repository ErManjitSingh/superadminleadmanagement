  ...
  return (
    <div className="sticky top-16 z-20 mb-6 rounded-2xl border border-subtle bg-surface/90 backdrop-blur-md p-4 shadow-sm">
      <div className="flex flex-wrap gap-3 items-end">
        <div>
          <label className="text-[10px] uppercase font-semibold text-content-muted mb-1 flex items-center gap-1"><Calendar className="w-3 h-3" /> From</label>
        ...
        <div>
          <label className="text-[10px] uppercase font-semibold text-content-muted mb-1 flex items-center gap-1"><Calendar className="w-3 h-3" /> To</label>
        ...
        <div>
          <label className="text-[10px] uppercase font-semibold text-content-muted mb-1 flex items-center gap-1"><MapPin className="w-3 h-3" /> Destination</label>
        ...
        <div>
          <label className="text-[10px] uppercase font-semibold text-content-muted mb-1 flex items-center gap-1"><Megaphone className="w-3 h-3" /> Source</label>
        ...
        <div>
          <label className="text-[10px] uppercase font-semibold text-content-muted mb-1 flex items-center gap-1"><User className="w-3 h-3" /> Executive</label>
        ...
        <div>
          <label className="text-[10px] uppercase font-semibold text-content-muted mb-1 flex items-center gap-1"><Package className="w-3 h-3" /> Package</label>
