...
export const ACTIVITY_CONFIG = {
  ...
  advance_payment_received: { label: 'Advance Payment Received', icon: FileText, color: 'bg-emerald-500/10 text-emerald-700' },
  payment_received: { label: 'Payment Received', icon: FileText, color: 'bg-emerald-500/10 text-emerald-600' },
  receipt_sent: { label: 'Receipt Sent', icon: FileText, color: 'bg-sky-500/10 text-sky-700' },
  booking_created: { label: 'Booking Created', icon: Trophy, color: 'bg-violet-500/10 text-violet-700' },
