...
const files = [
  ...
  'backend/src/controllers/navCountsController.js',
  'backend/src/routes/navCountsRoutes.js',
  'backend/src/routes/index.js',
  'frontend/src/hooks/useSidebarCounts.js',
  'frontend/src/lib/applySidebarCounts.js',
  ...
  'frontend/src/components/sales-manager/sidebar-config.js',
  'frontend/src/components/sales-executive/sidebar-config.js',
  'frontend/src/components/team-leader/sidebar-config.js',
  'frontend/src/components/team-leader/LeaderDashboard.jsx',
  'frontend/src/components/operations-manager/sidebar-config.js',
];
