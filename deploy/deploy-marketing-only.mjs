...
EOF`,
  ...
  'npm install --silent',
  'npm run build',
  "echo '==> Publish marketing (preserve root /app and /uploads only)...'",
  // IMPORTANT: '/app/' (anchored) — bare 'app/' also skips Next.js _next/static/chunks/app/
  `rsync -a --delete --exclude '/app/' --exclude '/uploads/' ${APP}/marketing/out/ ${WEB}/`,
  ...
  `curl -sI https://indiaholidaydestination.com/_next/static/chunks/app/page-f0ee82d01f7226ed.js | head -n 5 || true`,
