...
const bookingPaymentRoutes = require('./bookingPaymentRoutes');
...
router.use('/booking-payments', bookingPaymentRoutes);
...
router.use('/company/email', emailIntegrationRoutes);
