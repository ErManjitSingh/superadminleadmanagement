...
const updateTemplate = asyncHandler(async (req, res) => {
  ...
  const template = await EmailTemplate.findOne(companyScopedIdFilter(req.params.id, req));
  assertTenantDocument(template, req, 'Template');
...
const deleteTemplate = asyncHandler(async (req, res) => {
  ...
  const template = await EmailTemplate.findOneAndDelete(companyScopedIdFilter(req.params.id, req));
  assertTenantDocument(template, req, 'Template');
