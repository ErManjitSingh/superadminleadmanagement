...
const LEAD_DETAIL_SELECT = `${LEAD_LIST_SELECT} city state pickup drop travelDate returnDate tripDays budgetRange leadType companyName hotelCategory mealPreference transportRequirement specialRequirements statusReason priority channel assigneeRole assignedManager teamId lastContactedAt lastContactMethod slaBreached infants`;
