...
export default function NotificationBell() {
  ...
  return (
    <div className="relative">
      <Button variant="ghost" size="icon" className="relative text-slate-300" onClick={() => setOpen((o) => !o)}>
      ...
      {open && (
        <Card className="absolute right-0 top-12 z-50 w-80 p-0 shadow-float">
              ...
              items.map((n) => (
                ...
                >
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <Badge className={
                      n.severity === 'critical' ? 'bg-red-500/15 text-red-700'
                        : n.severity === 'warning' ? 'bg-amber-500/15 text-amber-700'
