...
/** Opens native builder with existing quote loaded. */
export default function QuotationPdfScreen() {
  ...
  useEffect(() => {
    if (!role || !id || query.isLoading || query.isError) return;
    ...
    return (
      <SafeAreaView style={styles.safe} edges={['top']}>
        ...
        <View style={styles.center}>
          ...
          >
            <Text style={styles.retryText}>Open builder</Text>
          </Pressable>
        </View>
      </SafeAreaView>
    );
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.center}>
        ...
        <Text style={styles.loadingText}>Opening quotation builder…</Text>
      </View>
    </SafeAreaView>
  );
}
...
const styles = StyleSheet.create({
  ...
  errorSub: { textAlign: 'center', color: '#64748B' },
  retryBtn: {
    marginTop: 8,
